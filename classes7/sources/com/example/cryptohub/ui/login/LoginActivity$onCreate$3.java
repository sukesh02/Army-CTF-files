...
final class LoginActivity$onCreate$3 extends Lambda implements Function1<String, Unit> {
    ...
    public LoginActivity$onCreate$3(LoginActivity loginActivity, EditText editText, EditText editText2) {
        super(1);
